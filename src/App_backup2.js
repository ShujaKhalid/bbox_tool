...
class ImgPic extends Component {
  ...
  render() {
    ...
    const offsetX = 25
    const offsetY = 334+26 //Hard coded for now
    //console.log(this.state)
      ...
      <div>
        ...
        <Draggable defaultPosition={{x: 0-offsetX, y: 0-offsetY}} onDrag={this.handleDrag} {...dragHandlers}>
          <div id='circle'>x: {deltaPosition.x.toFixed(0)} y: {deltaPosition.y.toFixed(0)}</div>
       </Draggable>
      </div>
	  </div>
	)
